...
from .order import BracketGroup, OCAGroup, OCOGroup, Order, OrderDetails, OrderManager
...
class Portfolio:
    ...
    def clear_updated_orders_and_trades(self) -> None:
        ...
        """
        self.order_manager.clear_updated_orders()
    ...
    def _generate_order_id(self) -> int:
        ...
        """
        unique_string = f"order_{datetime.now().timestamp()}_{len(self.pending_orders)}_{uuid.uuid4()}"
