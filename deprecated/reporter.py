...
class Reporter:
    ...
    def calculate_total_return(self) -> ExtendedDecimal:
        """
        Calculate the total return of the portfolio.

        Returns:
            ExtendedDecimal: The total return as a percentage.
        """
        return self._cached_calculation(
            "total_return", self._calculate_total_return_impl
        )

    def _calculate_total_return_impl(self) -> ExtendedDecimal:
        """
        ...
        return (final_equity - initial_equity) / initial_equity * ExtendedDecimal("100")

    def calculate_sharpe_ratio(
        self, risk_free_rate: ExtendedDecimal = ExtendedDecimal("0.02")
    ) -> ExtendedDecimal:
        """
        Calculate the Sharpe ratio of the portfolio.

        Args:
            risk_free_rate (ExtendedDecimal): The risk-free rate, default is 2%.

        Returns:
            ExtendedDecimal: The calculated Sharpe ratio.
        """
        return self._cached_calculation(
            "sharpe_ratio", self._calculate_sharpe_ratio_impl, risk_free_rate
        )

    def _calculate_sharpe_ratio_impl(
        self, risk_free_rate: ExtendedDecimal
    ) -> ExtendedDecimal:
        """
        Implementation of Sharpe ratio calculation.

        Args:
            risk_free_rate (ExtendedDecimal): The risk-free rate.
        ...
        return ExtendedDecimal(str(sharpe_ratio))

    def calculate_sortino_ratio(
        self,
        risk_free_rate: ExtendedDecimal = ExtendedDecimal("0.02"),
        target_return: ExtendedDecimal = ExtendedDecimal("0"),
    ) -> ExtendedDecimal:
        """
        ...
        Args:
            risk_free_rate (ExtendedDecimal): The risk-free rate, default is 2%.
            target_return (ExtendedDecimal): The target return, default is 0%.

        Returns:
            ExtendedDecimal: The calculated Sortino ratio.
        """
        return self._cached_calculation(
            "sortino_ratio",
    ...
    def _calculate_sortino_ratio_impl(
        self, risk_free_rate: ExtendedDecimal, target_return: ExtendedDecimal
    ) -> ExtendedDecimal:
        """
        ...
        Args:
            risk_free_rate (ExtendedDecimal): The risk-free rate.
            target_return (ExtendedDecimal): The target return.
        ...
        return ExtendedDecimal(str(sortino_ratio))

    def calculate_max_drawdown(self) -> ExtendedDecimal:
        """
        Calculate the maximum drawdown of the portfolio.

        Returns:
            ExtendedDecimal: The maximum drawdown as a percentage.
        """
        return self._cached_calculation(
            "max_drawdown", self._calculate_max_drawdown_impl
        )

    def _calculate_max_drawdown_impl(self) -> ExtendedDecimal:
        """
        ...
        return ExtendedDecimal(str(abs(max_drawdown) * 100))

    def calculate_win_rate(self) -> ExtendedDecimal:
        """
        Calculate the win rate of closed trades.

        Returns:
            ExtendedDecimal: The win rate as a percentage.
        """
        return self._cached_calculation("win_rate", self._calculate_win_rate_impl)

    def _calculate_win_rate_impl(self) -> ExtendedDecimal:
        """
        ...
        return (
            ExtendedDecimal(winning_trades) / ExtendedDecimal(len(closed_trades)) * 100
        )

    def calculate_profit_factor(self) -> ExtendedDecimal:
        """
        Calculate the profit factor of the portfolio.

        Returns:
            ExtendedDecimal: The profit factor.
        """
        return self._cached_calculation(
            "profit_factor", self._calculate_profit_factor_impl
        )

    def _calculate_profit_factor_impl(self) -> ExtendedDecimal:
        """
        ...
        if total_loss == 0:
            return ExtendedDecimal("inf") if total_profit > 0 else ExtendedDecimal("0")

        return total_profit / total_loss

    def calculate_calmar_ratio(self, years: int = 3) -> ExtendedDecimal:
        """
        ...
        Returns:
            ExtendedDecimal: The calculated Calmar ratio.
        """
        return self._cached_calculation(
            "calmar_ratio", self._calculate_calmar_ratio_impl, years
        )

    def _calculate_calmar_ratio_impl(self, years: int) -> ExtendedDecimal:
        """
        ...
        if max_drawdown == ExtendedDecimal("0"):
            return ExtendedDecimal("inf") if total_return > 0 else ExtendedDecimal("0")
    ...
    def calculate_value_at_risk(
        ...
        Returns:
            ExtendedDecimal: The calculated Value at Risk.
        """
        return self._cached_calculation(
            "value_at_risk", self._calculate_value_at_risk_impl, confidence_level
        )

    def _calculate_value_at_risk_impl(self, confidence_level: float) -> ExtendedDecimal:
        """
        ...
        return ExtendedDecimal(str(abs(var)))
    ...
    def calculate_expected_shortfall(
        ...
        Returns:
            ExtendedDecimal: The calculated Expected Shortfall.
        """
        return self._cached_calculation(
            "expected_shortfall",
    ...
    def _calculate_expected_shortfall_impl(
        ...
        return ExtendedDecimal(str(abs(es)))
    ...
    def generate_position_report(self) -> pd.DataFrame:
        ...
        for symbol, size in positions.items():
            ...
            avg_entry_price = self.portfolio.avg_entry_prices.get(
                symbol, ExtendedDecimal("0")
            )
    ...
    def calculate_risk_reward_ratio(self) -> ExtendedDecimal:
        """
        Calculate the overall risk-reward ratio of the strategy.

        Returns:
            ExtendedDecimal: The calculated risk-reward ratio.
        """
        avg_win = self._calculate_average_win()
        avg_loss = self._calculate_average_loss()
        return avg_win / abs(avg_loss) if avg_loss != 0 else ExtendedDecimal("inf")

    def _calculate_average_win(self) -> ExtendedDecimal:
        """
        Calculate the average winning trade amount.

        Returns:
            ExtendedDecimal: The average winning trade amount.
        """
        winning_trades = [
    ...
    def _calculate_average_loss(self) -> ExtendedDecimal:
        """
        Calculate the average losing trade amount.

        Returns:
            ExtendedDecimal: The average losing trade amount.
        """
        losing_trades = [
            trade for trade in self.portfolio.closed_trades if trade.metrics.pnl < 0
        ]
